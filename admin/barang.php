      ...
      <section class="col-lg-12">
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Barang Toko Bulan</h3>
          ...
          <div class="box-body">
            ...
            <!-- Modal -->
            <form action="barang_act.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="nambar" required="required" class="form-control" placeholder="Masukkan nama barang ..">
                      </div>
              ...
              <table class="table table-bordered table-striped" id="table-datatable">
                <thead>
                  <tr>
                    ...
                    <th width="10%" rowspan="2" class="text-center">NAMA BARANG</th>
